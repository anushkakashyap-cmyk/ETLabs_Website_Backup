 ...
 */
// Title with subtitle and icon
require_once plugin_dir_path(__FILE__) . 'title_subtitle_icon.php';
require_once plugin_dir_path(__FILE__) . 'title_subtitle_icon_item.php';
require_once plugin_dir_path(__FILE__) . 'title_icon_item.php';

// Thumbnail with title
require_once plugin_dir_path(__FILE__) . 'title_thumbnail.php';
require_once plugin_dir_path(__FILE__) . 'title_thumbnail_item.php';