<section class="agency_testimonial_area sec_pad">
    <div class="container">
        <?php if ( !empty($settings['title']) ) : ?>
            <<?php echo $title_tag; ?> class="f_size_30 f_600 t_color3 l_height40 text-center mb_60 ata_style_1_title">
                ...
                <div class="testimonial_item text-center <?php echo esc_attr($align_class) ?>">
                    ...
                    <?php if (!empty($testimonial['name'])): ?>
                        <div class="author_description">
                            <h4 class="f_500 t_color3 f_size_18 name"> <?php echo esc_html($testimonial['name']); ?> </h4>
                            <?php echo !empty($testimonial['designation']) ? '<h6 class="designation">'.esc_html($testimonial['designation']).'</h6>' : ''; ?>
                        </div>
                    <?php endif; ?>
