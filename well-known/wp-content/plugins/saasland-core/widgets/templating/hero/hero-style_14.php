...
<section class="banner_section home_one_banner deco_wrap d-flex align-items-center" id="apps_craft_animation">
        ...
        <div class="row align-items-center justify-content-lg-between">
            <div class="col-lg-6 order-last">
                ...
                <?php
                    ...
                    <iframe width="420" height="315" class="img women_img video_popup" src="https://www.youtube.com/embed/<?php echo $settings['feature_video']; ?>"></iframe>
                <?php 
                 }
                ?>
            </div>
            <div class="col-lg-6">
                <div class="banner_content">
                    ...
                    if( !empty( $settings['title'] ) ){
                        echo '<h1 class="title_text title wow fadeInUp">'.wp_kses_post( nl2br( $settings['title'] ) ).'</h1>';
                    }
                    if( !empty( $settings['subtitle'] ) ){
                        echo '<p class="content wow fadeInUp" data-wow-delay="0.3s">'. wp_kses_post( nl2br( $settings['subtitle'] ) ) .'</p>';
                    }
    ...
    if( !empty( $settings['mail_shape_img1']['url'] ) ){ ?>
        <div class="deco_image shape_01">
            <img class="layer" data-depth="0.2" src="<?php echo esc_url( $settings['mail_shape_img1']['url'] ) ?>" alt="shape_image_not_found">
        </div>
        <?php
    }
