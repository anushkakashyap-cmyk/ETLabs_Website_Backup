...
<?php if($settings['feature_style2'] =='images' ){ ?>
    <div class="animation_img_two wow fadeInRight" data-wow-delay="0.5s">
        <?php echo wp_get_attachment_image($settings['fimage3']['id'], 'full' ) ?>
    </div>
<?php }else{ ?>
    <div class="animation_img_two wow fadeInRight" data-wow-delay="0.5s">
        <iframe width="420" height="315" class="video_popup" src="https://www.youtube.com/embed/<?php echo $settings['feature_video2']; ?>"></iframe>
    </div>
<?php } ?>
