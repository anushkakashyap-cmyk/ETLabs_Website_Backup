...
class Subscribe_Form extends Widget_Base {
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            'subscribe_form_input_border', [
                'label' => __( 'Input Field Border Color', 'saasland-core' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .subcribes .form-control' => 'border-color: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            'sec_height', [
                'label' => esc_html__( 'Section Height', 'saasland-core' ),
