...
class Features_with_image_white extends Widget_Base {
    ...
    public function get_title() {
        return __( 'Features <br> with Image (White)', 'saasland-core' );
    }
    ...
    protected function register_controls() {
        ...
        $repeater_fields->add_control(
            'btn_colors_heading',
            [
                'label'     => __( 'Button Colors', 'saasland-core' ),
        ...
        $repeater_fields->add_control(
            'btn1_heading',
            [
                'label'     => __( 'Button 01', 'saasland-core' ),
                'type'      => Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
        ...
        $repeater_fields->add_control(
            'btn2_heading',
            [
                'label'     => __( 'Button 02', 'saasland-core' ),
                'type'      => Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
