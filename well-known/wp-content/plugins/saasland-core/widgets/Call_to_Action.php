...
class Call_to_Action extends Widget_Base {
    ...
    public function get_title() {
        return __( 'Call to Action (Theme)', 'saasland-core' );
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            'btn_bg_color', [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .software_featured_content .btn_four' => 'background: {{VALUE}};',
        ...
        $this->add_control(
            'btn_border_color', [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .call_action_area .action_content .action_btn' => 'border-color: {{VALUE}};',
                    '{{WRAPPER}} .er_btn_two' => 'border-color: {{VALUE}};',
                    '{{WRAPPER}} .software_featured_content .btn_four' => 'border-color: {{VALUE}};',
                    ...
                    '{{WRAPPER}} .action_content .btn_three' => 'border-color: {{VALUE}};',
                ]
            ]
        );
        ...
        $this->add_control(
            'hover_font_color', [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .call_action_area .action_content .action_btn:hover' => 'color: {{VALUE}};',
                    '{{WRAPPER}} .payment_action_content .pay_btn:hover' => 'color: {{VALUE}};',
                    '{{WRAPPER}} .action_content .btn_three:hover' => 'color: {{VALUE}};',
                    ...
                    '{{WRAPPER}} .software_featured_content .btn_four:hover' => 'color: {{VALUE}};',
                ]
            ]
        );
        ...
        $this->add_control(
            'hover_bg_color', [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .action_content .btn_three:hover' => 'background: {{VALUE}};',
                    ...
                    '{{WRAPPER}} .software_featured_content .btn_four:hover' => 'background: {{VALUE}};',
                ]
            ]
        );
        ...
        $this->add_control(
            'hover_border_color', [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .call_action_area .action_content .action_btn:hover' => 'border-color: {{VALUE}};',
                    '{{WRAPPER}} .action_content .btn_three:hover' => 'border-color: {{VALUE}};',
                    ...
                    '{{WRAPPER}} .software_featured_content .btn_four:hover' => 'border-color: {{VALUE}};',
                ]
        ...
        $this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', 'em', '%' ],
				'selectors' => [
					'{{WRAPPER}} .get_started_section' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
