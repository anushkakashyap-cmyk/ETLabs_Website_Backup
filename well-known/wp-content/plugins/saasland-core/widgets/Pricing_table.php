...
class Pricing_table extends Widget_Base {
	...
	public function get_title() {
		return __( 'Pricing Table', 'saasland-core' );
	}
    ...
    protected function register_controls() {
        ...
        $repeater_t_1 = new \Elementor\Repeater();
        $repeater_t_1->add_control(
			'title', [
        ...
        $repeater_t_1->add_control(
            'title_price_tag',
            [
                'label' => __( 'Price HTML Tag', 'saasland-core' ),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    'h1' => 'H1',
                    'h2' => 'H2',
        ...
        $repeater_t_1->add_control(
			'contents', [
                ...
                'description' => __( 'Wrap up every list item with li tag (<li>Item Name</li>).', 'saasland-core' ),
						'label_block' => true,
						'default' =>'<ul class="list-unstyled mt_30">
        ...
        $this->add_control(
			...
			[
				...
				'fields' => $repeater_t_1->get_controls(),
                'prevent_empty' => false,
				'title_field' => '{{{ title }}}',
                'condition' => [
				    'style' => 'style_01'
        ...
        $repeater->add_control(
            'btn_url', [
                'label' => esc_html__( 'Button URL ddd', 'saasland-core' ),
                'type' =>Controls_Manager::URL,
                'default' => [
                    'url'   => '#'
                ]
	...
	protected function render() {
        ...
        include "templating/pricing-table/{$settings['style']}.php";
