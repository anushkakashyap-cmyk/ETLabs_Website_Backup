...
class Testimonial_ratting extends \Elementor\Widget_Base {
    ...
    protected function register_controls() {
        ...
        $testimonials = new \Elementor\Repeater();
        ...
        $testimonials->add_control(
			...
			[
				...
				'placeholder' => esc_html__( 'Name', 'saasland-core' ),
			]
		);
        ...
        $testimonials->add_control(
			...
			[
				...
				'type' => \Elementor\Controls_Manager::TEXT,
				'placeholder' => esc_html__( 'Designation', 'saasland-core' ),
			]
		);
		...
		$testimonials->add_control(
			...
			[
				...
				'rows' => 10,
				'placeholder' => esc_html__( 'Type your Testimonial Text here', 'saasland-core' ),
			]
		);
        ...
        $testimonials->add_control(
			'ratting', [
				...
				'default' => '5',
				'options' => [
                    '1' => esc_html__('One', 'saasland-core'),
	    ...
	    $this->add_control(
		    'bg_shape_img', [
			    'label' => __( 'Background Image', 'saasland-core' ),
			    'type' => Controls_Manager::MEDIA,
			    'condition' => [
				    'style' => 'style_01',
			    ]
