...
class Events {
    ...
    public function register() {
        ...
        $slug = !empty($opt['events_slug']) ? strtolower(str_replace( ' ', '', $opt['events_slug'])) : $this->slug;
        $labels = array(
            'name'                  => esc_html_x( 'Events', 'Post Type General Name', 'saasland-core' ),
            'singular_name'         => esc_html_x( 'Events', 'Post Type Singular Name', 'saasland-core' ),
