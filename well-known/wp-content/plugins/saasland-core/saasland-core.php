	...
	class Saasland_core {
		...
		private function register_widgets() {
            ...
            $widgets = array(
                ...
                'Image_slideshow', 'Portfolio_masonry_simple', 'Event', 'Shop_slider',
            );
   ...
   if ( $screen->base == 'toplevel_page_Saasland' || $screen->base == 'toplevel_page_saasland' ) { ?>
       ...
       <div class="notice is-dismissible" style="padding:0; border:0; background: transparent; margin-top:30px">
           <a target="_blank" href="https://www.hubspot.com/marketing/free/wordpress-intro">
               <img style="max-width: 100%" src="<?php echo esc_url( plugin_dir_url( __FILE__ ) . 'assets/img/hubspot-banner.png'); ?>" alt="<?php esc_attr_e('Banner', 'saasland-core'); ?>">
           </a>
       </div>

       <div class="notice is-dismissible" style="padding:0; border:0; background: transparent; margin-top: 15px">
            <a href="https://droitthemes.com/droit-elementor-addons/?ref=5&utm_source=Saasland_Theme&utm_medium=SL_ThemeSettings&utm_campaign=Saasland">
            	<img style="max-width: 100%" src="https://saasland.droitlab.com/image/addons-banner.png" alt="<?php esc_attr_e('Banner', 'saasland-core'); ?>">
            </a>
       </div>
	    <?php
   }
