! function(e, t, i) {
    ...
    window.liteTranslated = function (e, t) {
        return elementorCommon.translate(e, null, t, saasTempEditor.i18n)
    };
    ...
    a.Models.Template = Backbone.Model.extend({
        ...
        getTemplateActionButton: function(e) {
            var t = e.isPro && !saasTempEditor.hasPro ? "pro-button" : "insert-button";
        ...
        function i() {
            ...
            n && _.each(n, function(e, t) {
                a === e.id && (p.atIndex = t)
            }), r.find(".saasland-add-lite-button").length || r.find(FIND_SELECTOR_SAASLAND).before($openLibraryButton)
        }

        function n(e) {
            var t = e.find(FIND_SELECTOR_SAASLAND);
            t.length && !e.find(".saasland-add-lite-button").length && t.before($openLibraryButton), e.on("click.onAddElement", ".elementor-editor-section-settings .elementor-editor-element-add", i)
        }
        ...
        function l() {
            ...
            e.on("click.onAddTemplateButton", ".saasland-add-lite-button", p.showModal.bind(p)), this.channels.tabs.on("change:device", r)
        }
        var o, s, d, c, m, p = this;
        FIND_SELECTOR_SAASLAND = ".elementor-add-new-section .elementor-add-section-drag-title", $openLibraryButton = '<div class="elementor-add-section-area-button saasland-add-lite-button"> <img src="'+saasTempEditor.templateLogo+'" /> </div>', devicesResponsiveMap = {
            desktop: "100%",
            tab: "768px",
            mobile: "360px"
            ...
            e.forceSync && (t.data.sync = !0), elementorCommon.ajax.addRequest("get_saasland_library_data", t)
            ...
            t && jQuery.extend(!0, i, t), elementorCommon.ajax.addRequest("get_saasland_template_data", i)
