    ...
    if (!is_user_logged_in()) :
        ...
        <div class="checkout_content">
            ...
            <div class="return_customer">
                <?php echo saasland_get_icon_svg('saasland-svg-icon', 'icon_error', '14') ?>
                <?php esc_html_e( 'Returning customer?', 'saasland' ) ?>
                <a data-bs-toggle="collapse" href="#coupon" aria-expanded="false" class="collapsed"> <?php esc_html_e( 'Click here to login', 'saasland' ) ?> </a>
            </div>
    ...
    <div class="col-lg-6">
        <div class="checkout_content coupon_form">
            ...
            <div class="return_customer">
                ...
                ' <a data-bs-toggle="collapse" href="#coupon_two" aria-expanded="false" class="collapsed">' . esc_html__( 'Click here to enter your code', 'saasland' ) . '</a>' );
                ?>
            </div>
